// src/components/ServiceCenterSignUp.jsx
import { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { createUserWithEmailAndPassword } from 'firebase/auth';
import { doc, setDoc } from 'firebase/firestore';
import { auth, db } from '../firebase';
import { EyeIcon, EyeSlashIcon, EnvelopeIcon, BuildingOfficeIcon, DocumentTextIcon, MapPinIcon } from '@heroicons/react/24/outline';
    ...
    <div className="flex flex-col items-center w-full animate-fade-in py-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md animate-slide-up animate-delay-200 border border-gray-100">
        <form onSubmit={handleRegister} className="flex flex-col gap-4 w-full">
          {/* Service Center Name Input with Icon */}
          ...
          {/* Certification Number and Address in Grid */}
